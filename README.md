...
using the following command to generate images from the new solver:
![Alt](gen_img_val_v15/samples-customed-8-free-notNPNet-full-trick-7.5/00002.png =192x256)
```
...
![Alt](gen_img_val_v15/samples-org-20-free-notNPNet/00002.png =192x256)
```
