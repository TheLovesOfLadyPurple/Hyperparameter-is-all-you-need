...
using the following command to generate images from the new solver:
![inpainting](gen_img_val_v15/samples-customed-8-free-notNPNet-full-trick-7.5/00002.png =76.8x102.4)
```
...
![inpainting](gen_img_val_v15/samples-org-20-free-notNPNet/00002.png =76.8x102.4)
```
